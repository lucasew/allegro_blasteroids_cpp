...
if command -v apt-get >/dev/null 2>&1; then
	...
	sudo apt-get update && sudo apt-get install -y liballegro5-dev liballegro-image5-dev liballegro-audio5-dev liballegro-acodec5-dev liballegro-ttf5-dev liballegro-dialog5-dev pkg-config
