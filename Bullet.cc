...
public:
  ...
  friend std::ostream &operator<<(std::ostream &out, const Bullet &obj) {
    return out << "Bullet(pos: " << obj.position << " heading: " << obj.heading
               << " speed: " << obj.speed << " power: " << obj.power << ")";
  }
  ...
  float getDangerRadius() { return 1; }
};

bool isValid(Bullet b) { return b.power > 0; }
